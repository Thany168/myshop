      ...
      <div>
        ...
        <div className=" mt-8 grid gap-y-4 md:grid-cols-2 md:gap-5  lg:grid-cols-2 xl:grid-cols-4 ">
          ...
          <div className=" rounded w-full  h-32 bg-[#006EE5]">
            ...
            <button className="w-full  text-white text-xs items-center bg-[#007CBA]">More Info <ArrowCircleRightIcon /></button>
          </div>
          ...
          <div className=" rounded w-full  h-32 bg-[#FFC107]">
            ...
            <button className="w-full   text-xs items-center bg-[#E5AD06]">More Info <ArrowCircleRightIcon /></button>
          </div>
        </div>
      </div>
    </>
